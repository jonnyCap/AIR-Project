...
if __name__ == '__main__':
    ...
    decoded_str = urllib.parse.unquote(args.company_and_stock)
    # Parse the decoded string as JSON
    company_stock = json.loads(decoded_str)
    # print(company_stock)
    companies = []
    # Example data for ten companies with realistic stock performance
    for company, stock_performance in company_stock.items():
    # Assuming `company` is the company's name and the rest is description,
    # we need to extract the company's idea from the description if needed.
        idea = company  # or you can choose to add the description if needed
        company_data = {
            "idea": idea,
...
# Now you can print the list of companies in the desired format
